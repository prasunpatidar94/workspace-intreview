...
public class LoansRestController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoanDto> fetchByMobileOrLoanNumber(@NotEmpty(message = "findByValue should not be Empty") @RequestParam String findByValue, @NotEmpty(message = "findBy should not be Empty") @RequestParam String findBy) {
    ...
    public ResponseEntity<ResponseDto> deleteByMobileOrLoanNumber(@NotEmpty(message = "findByValue should not be Empty") @RequestParam String findByValue, @NotEmpty(message = "findBy should not be Empty") @RequestParam String findBy) {
